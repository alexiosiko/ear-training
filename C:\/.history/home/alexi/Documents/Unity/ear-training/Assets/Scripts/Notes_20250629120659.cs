...
public class Notes : MonoBehaviour
{
	...
	public void AddNote(int childCount)
	{
		...
		// Get x pos
		float totalWidth = trembleCleffTransform.GetComponent<RectTransform>().rect.width;
		float gap = trembleCleffTransform.GetComponent<RectTransform>().rect.width / 5f;
		float x = gap * notes.Count;
